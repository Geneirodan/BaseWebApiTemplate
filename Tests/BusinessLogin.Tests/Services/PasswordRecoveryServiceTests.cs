...
[TestSubject(typeof(PasswordRecoveryService))]
public class PasswordRecoveryServiceTests
{
    ...
    public PasswordRecoveryServiceTests()
    {
        ...
        _passwordRecoveryService = new PasswordRecoveryService(_userManager.Object, _repository.Object, options);
    }
    ...
    public async Task ResetPasswordAsync(ResetPasswordModel model)
    {
        ...
        var result = await _passwordRecoveryService.ResetPasswordAsync(model);
    ...
    public async Task AddPasswordAsync(AddPasswordModel model)
    {
        ...
        var result = await _passwordRecoveryService.AddPasswordAsync(model);
    ...
    public async Task ChangePasswordAsync(ChangePasswordModel model)
    {
        ...
        var result = await _passwordRecoveryService.ChangePasswordAsync(model);
    ...
    public async Task ChangePasswordAsync_ModelNotValid(ChangePasswordModel model)
    {
        ...
        result.IsSuccess.Should().BeFalse();
        result.Errors.TestPasswordValidationResult(newPassword, _options);
    }
}
